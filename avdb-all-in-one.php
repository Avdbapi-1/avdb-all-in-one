...
$avdb_webkit_packages = [
    [
        ...
        'name' => 'AVDB Crawler for WP-Script',
        'type' => 'plugin',
        'description' => 'Crawler for WP-Script. Version 2.2.1',
        ...
        'image' => 'https://i.imgur.com/XBfLNMG.png',
        'group' => 'official',
        'note' => 'Hot'
    ],
    [
        'slug' => 'adult-api-crawler-for-eroz-theme',
        'name' => 'AVDB Crawler for Eroz',
        'type' => 'plugin',
        'description' => 'Crawler for Eroz. Version 2.3.1',
        'download_url' => 'https://github.com/Avdbapi-1/adult-api-crawler-for-eroz-theme/releases/download/V2.2.1/adult-api-crawler-for-eroz-theme.zip',
        'image' => 'https://i.imgur.com/CAae7GG.jpeg',
        'group' => 'official',
        'note' => 'Recommended'
    ],
    [
        'slug' => 'crawl-avdbapi-vidmov',
        'name' => 'AVDB Crawler for VidMov',
        'type' => 'plugin',
        'description' => 'Crawler for VidMov. Version 2.3.1',
        'download_url' => 'https://github.com/Avdbapi-1/crawl-avdbapi-vidmov/releases/download/V2.3.0/crawl-avdbapi-vidmov.zip',
        'image' => 'https://i.imgur.com/0HGm2Oq.jpeg',
        'group' => 'official',
        'note' => ''
    ],
    [
        'slug' => 'avdbapi-crawler-dooplay',
        'name' => 'AVDB Crawler for DooPlay',
        'type' => 'plugin',
        'description' => 'Crawler for DooPlay. Version 1.0.1',
        'download_url' => 'https://github.com/Avdbapi-1/avdbapi-crawler-dooplay/releases/download/V1.0.0/avdbapi-crawler-dooplay.zip',
        'image' => 'https://i.imgur.com/51hV1Mz.png',
        'group' => 'official',
        'note' => 'New'
    ],
    [
        'slug' => 'adult-api-crawler-for-videoclub-theme',
        'name' => 'AVDB Crawler for VideoClub',
        'type' => 'plugin',
        'description' => 'Crawler for VideoClub. Version 2.0.1',
        ...
        'image' => 'https://i.imgur.com/AWkG4ms.jpeg',
        'group' => 'official',
        'note' => 'Recommended'
    ],
    [
    ...
    [
        ...
        'name' => 'VideoClub Theme',
        'type' => 'theme',
        'description' => 'VideoClub Theme',
...
function avdbwki_get_installed_version($pkg, $allPlugins = null, $allThemes = null)
{
    ...
    if (isset($version_cache[$cache_key]))
...
function avdb_webkit_installer_page()
{
    ...
    $official = array_filter($avdb_webkit_packages, function ($p) {
        return $p['group'] === 'official';
    });
    $thirdparty = array_filter($avdb_webkit_packages, function ($p) {
        return $p['group'] === 'thirdparty';
    });
    ...
    <style>
        ...
        .avdbwki-card__note.avdbwki-note-recommended {
            background: #10b981;
        }

        .avdbwki-card__note.avdbwki-note-hot {
            background: #ef4444;
        }

        .avdbwki-card__note.avdbwki-note-new {
            background: #8b5cf6;
        }

        .avdbwki-card__note.avdbwki-note-popular {
            background: #f59e0b;
        }

        .avdbwki-card__note.avdbwki-note-required {
            background: #dc2626;
        }
        ...
        .avdbwki-install-btn.is-working {
            background: #cbd5e1;
            color: #111827;
            cursor: wait;
        }

        .avdbwki-install-btn.is-installed {
            background: #22c55e;
            color: #fff;
            cursor: default;
        }

        .avdbwki-install-btn:not(.is-installed):not(.is-working):hover {
            background: #2563eb;
            transform: translateY(-1px);
        }

        .avdbwki-card__bottom {
            margin-top: auto;
        }
        ...
        .avdbwki-card:hover .avdbwki-card__shine {
            opacity: 1;
            animation: avdbwki-shine 3s infinite;
        }

        .avdbwki-card:hover .avdbwki-card__glow {
            opacity: 1;
        }

        .avdbwki-card:hover .avdbwki-card__badge {
            transform: scale(1);
            opacity: 1;
            z-index: 1;
        }

        .avdbwki-card:hover .avdbwki-card__image {
            transform: translateY(-5px) scale(1.03);
            box-shadow: 0 10px 15px -3px rgba(0, 0, 0, 0.1);
        }

        .avdbwki-card:hover .avdbwki-card__title {
            color: var(--card-accent);
        }

        .avdbwki-card:hover .avdbwki-card__description {
            opacity: 1;
        }
        ...
        .avdbwki-section-title.official {
            color: #22c55e;
            border-color: #22c55e;
        }

        .avdbwki-section-title.thirdparty {
            color: #ef4444;
            border-color: #ef4444;
        }
        ...
        .avdbwki-update-btn.visible {
            visibility: visible;
        }

        .avdbwki-update-btn[disabled] {
            opacity: .6;
            cursor: wait;
        }

        .avdbwki-update-btn:not([disabled]):hover {
            background: #d97706;
        }
        ...
        .avdbwki-find-btn:not([disabled]):hover {
            background: #0284c7;
        }
        ...
        .avdbwki-loading {
            ...
            animation: avdbwki-spin 1s linear infinite;
        }

        @keyframes avdbwki-spin {
            to {
    ...
    <div class="wrap avdbwki-wrap">
        ...
        <button type="button" id="avdbwki-find-updates" class="avdbwki-find-btn"><span class="text">Check for
                Updates</span></button>
        <button type="button" id="avdbwki-clear-cache" class="avdbwki-find-btn" style="background: #f59e0b;"><span
                class="text">Clear Cache</span></button>
        <div id="avdbwki-result"></div>
        <div class="avdbwki-section-title official">AVDB Official Packages</div>
        <div class="avdbwki-note">Installing multiple crawl plugins on the same website at the same time will cause errors,
            please delete the old crawl when downloading the new crawl.</div>
        <div class="avdbwki-grid">
            <?php foreach ($official as $pkg):
                ...
                <div class="avdbwki-card" data-slug="<?php echo esc_attr($pkg['slug']); ?>">
                    <div class="avdbwki-card__shine"></div>
                    <div class="avdbwki-card__glow"></div>
                    <?php if (!empty($pkg['note'])): ?>
                        <div class="avdbwki-card__note avdbwki-note-<?php echo strtolower(htmlspecialchars($pkg['note'])); ?>">
                            <?php echo htmlspecialchars($pkg['note']); ?>
                        </div><?php endif; ?>
                    <div class="avdbwki-card__content">
                        <div class="avdbwki-card__badge"><?php echo strtoupper(htmlspecialchars($pkg['type'])); ?></div>
                        <div class="avdbwki-card__image"><?php if (!empty($pkg['image'])): ?><img
                                    src="<?php echo esc_url($pkg['image']); ?>"
                                    alt="<?php echo esc_attr($pkg['name']); ?>"><?php endif; ?></div>
                        <div class="avdbwki-card__text">
                            ...
                            <p class="avdbwki-meta">Installed: <span
                                    class="avdbwki-installed-version"><?php echo $installed_version ? htmlspecialchars($installed_version) : '—'; ?></span>
                            </p>
                            <p class="avdbwki-meta">Latest: <span class="avdbwki-latest-version">—</span></p>
                            <p class="avdbwki-status <?php echo $is_installed ? 'ok' : 'warn'; ?>">
                        ...
                        <div class="avdbwki-card__bottom">
                            <div class="avdbwki-btn-line">
                                <button type="button"
                                    class="avdbwki-install-btn <?php echo $is_installed ? 'is-installed' : ''; ?>"
                                    data-slug="<?php echo esc_attr($pkg['slug']); ?>"><?php echo $is_installed ? 'Installed' : 'Install'; ?></button>
                                <button type="button" class="avdbwki-update-btn"
                                    data-slug="<?php echo esc_attr($pkg['slug']); ?>">Update</button>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <div id="avdbwki-image-modal"
        style="display:none;position:fixed;z-index:9999;top:0;left:0;width:100vw;height:100vh;background:rgba(30,41,59,0.7);align-items:center;justify-content:center;">
        <div
            style="position:relative;max-width:96vw;max-height:96vh;display:flex;align-items:center;justify-content:center;">
            <img id="avdbwki-image-modal-img" src="" alt="Zoom"
                style="max-width:96vw;max-height:96vh;border-radius:16px;box-shadow:0 8px 32px rgba(0,0,0,0.25);background:#fff;">
            <button id="avdbwki-image-modal-close"
                style="position:absolute;top:8px;right:8px;background:#fff;border:none;border-radius:50%;width:36px;height:36px;box-shadow:0 2px 8px rgba(0,0,0,0.15);font-size:22px;cursor:pointer;">&times;</button>
        </div>
    </div>
...
add_action('wp_ajax_avdb_webkit_install', function () {
    if (!current_user_can('manage_options') || !check_ajax_referer('avdb_install_nonce', '_wpnonce', false))
        wp_send_json_error('Security check failed');

    $slug = sanitize_text_field($_POST['slug'] ?? '');
    if (empty($slug))
        wp_send_json_error('No package selected');

    global $avdb_webkit_packages;
    $pkg = null;
    foreach ($avdb_webkit_packages as $p) {
        if ($p['slug'] === $slug) {
            $pkg = $p;
            break;
        }
    ...
    if (avdbwki_is_package_installed($pkg))
        wp_send_json_error($pkg['name'] . ' is already installed.');

    require_once ABSPATH . 'wp-admin/includes/file.php';
    require_once ABSPATH . 'wp-admin/includes/class-wp-upgrader.php';
    if (!WP_Filesystem())
        wp_send_json_error('Cannot access filesystem');
...
add_action('wp_ajax_avdbwki_find_updates', function () {
    if (!current_user_can('manage_options') || !check_ajax_referer('avdb_update_nonce', '_wpnonce', false))
        wp_send_json_error('Security check failed');
    global $avdb_webkit_packages;
    $json = avdbwki_get_manifest_data(true);
    if (!$json)
        wp_send_json_error('Cannot connect to update server');
    $manifest_map = [];
    foreach ($json as $item) {
        if (!empty($item['slug']))
            $manifest_map[$item['slug']] = $item;
    }
    wp_cache_delete('plugins', 'plugins');
    $update_info = [];
...
add_action('wp_ajax_avdbwki_update_package', function () {
    ...
    if (!$target_package)
        wp_send_json_error('Package definition not found');
    $json = avdbwki_get_manifest_data(true);
    if (!$json)
        wp_send_json_error('Cannot connect to update server');
    $manifest_entry = null;
    ...
    if (!$manifest_entry || empty($manifest_entry['download_url']))
        wp_send_json_error('Package not in manifest or missing URL');
    ...
    if (!$current_path)
        wp_send_json_error('Package not installed or path not found.');

    $skin = new WP_Ajax_Upgrader_Skin();
    try {
        if (strtolower($target_package['type']) === 'plugin')
            $upgrader = new Plugin_Upgrader($skin);
        else
            $upgrader = new Theme_Upgrader($skin);
